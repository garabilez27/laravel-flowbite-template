...
<form class="mt-8 space-y-6" action="#">
    ...
    <div class="flex items-start">
        <div class="flex items-start">
            ...
            <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I accept the <a href="#" class="text-blue-700 hover:underline dark:text-blue-500">Terms and Conditions</a></label>
        </div>
    </div>
    ...
    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
        Already have an account? <a href="{{ route('signin') }}" class="text-blue-700 hover:underline dark:text-blue-500">Login here</a>
    </div>
</form>
