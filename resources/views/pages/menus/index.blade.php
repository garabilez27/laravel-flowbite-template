            ...
            <div class="overflow-hidden shadow">
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @foreach ($records['menus'] as $n => $menu)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td class="p-4 text-sm font-bold text-gray-500 whitespace-nowrap dark:text-gray-400">{{ ++$n }}</td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">{{ $menu->mn_prefix }}</td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">{{ $menu->mn_detail }}</td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">{{ $menu->mn_icon }}</td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">{{ $menu->mn_reference }}</td>
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    ...
                                    <button type="button" data-drawer-target="drawer-update-default" data-drawer-show="drawer-update-default" aria-controls="drawer-update-default" data-drawer-placement="right" class="menu-form inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" value="{{ md5($menu->mn_id) }}">
...
<div id="drawer-delete-default" class="fixed top-0 right-0 z-[45] w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
    ...
    <form action="{{ route('mn.delete') }}" method="post">
        @csrf
...
@include('pages.menus.add')
@include('pages.menus.edit')
