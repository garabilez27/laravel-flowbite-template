...
<form class="mt-8 space-y-6" action="{{ route('validate') }}" method="post">
    @csrf
    <div>
    ...
    <div class="flex items-start">
        ...
        <a href="{{ route('forgot') }}" class="ms-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Lost Password?</a>
    </div>
    ...
    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
        Not registered? <a href="{{ route('signup') }}" class="text-blue-700 hover:underline dark:text-blue-500">Create account</a>
    </div>
</form>
@endsection
